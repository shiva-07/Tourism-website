...
body
{
	...
	background:url(images/ladakhc6.jpg)no-repeat center center fixed;
...
<section class="my-2">
	...
	<div class="w-50 m-auto">
		<form action="ladakh.php" method="post">
  ...
  document.getElementById('number').value = value;
	...
	<label for="inputState">Travel By:</label>
		...
		<div class="col-lg-6 col md-4 col-12">
			...
			<ul style="list-style-type:square;">
				...
				<li><i class="fa fa-star" aria-hidden="true"> 3/2 Star Hotel</i></li>
				...
				<li>Starting from <i class="fa fa-inr" aria-hidden="true" name="pay">7980 per night for 2adults</i></li>
			</ul>
	</div>
	...
	<div class="col-lg-6 col-md-4 col-12">
			...
			<ul style="list-style-type:square;">
				...
				<li><i class="fa fa-shower" aria-hidden="true"> Cleaning services</i></li>
				<li><i class="fa fa-lock" aria-hidden="true"> Safety & Security</i></li>
				<li>Starting from <i class="fa fa-inr" aria-hidden="true">2500 per night for 2adults</i></li>
  			</ul>
	</div>
	</div><br>
