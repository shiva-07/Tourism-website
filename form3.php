...
body
{
	background:url(images/jaipurc4.jpg)no-repeat center center fixed;
...
<section class="my-2">
	...
	<div class="w-50 m-auto">
		<form action="jaipur.php" method="post">
  ...
  document.getElementById('number').value = value;
	...
	<label for="inputState">Travel By:</label>
		...
		<div class="col-lg-6 col md-4 col-12">
			...
			<ul style="list-style-type:square;">
				...
				<li><i class="fa fa-star" aria-hidden="true"> 5/3/2 Star Hotel</i></li>
				...
				<li>Starting from <i class="fa fa-inr" aria-hidden="true">5870 per night for 2adults</i></li>
			</ul>
	</div>
	...
	<div class="col-lg-6 col-md-4 col-12">
			...
			<ul style="list-style-type:square;">
				...
				<li><i class="fa fa-shower" aria-hidden="true"> Cleaning services</i></li>
				<li><i class="fa fa-lock" aria-hidden="true"> Safety & Security</i></li>
				<li>Starting from <i class="fa fa-inr" aria-hidden="true">890 per night for 2adults</i></li>
			</ul>
	</div>
	</div><br>
